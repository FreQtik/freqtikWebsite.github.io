    ...
    const IMPULSE_ANVIL_DOWNLOAD = 'https://github.com/FreQtik/freqtikWebsite.github.io/releases/download/v1.0.124/ImpulseAnvil_Windows_VST3.zip';
    const IMPULSE_ANVIL_MAC_RELEASE = 'https://github.com/FreQtik/freqtikWebsite.github.io/releases/tag/v1.0.124';
...
<ul class="ia-list"><li>Windows VST3 + Standalone; macOS AU/VST3/Standalone testing builds available separately</li><li>126 included IRs</li><li>Time Morph available</li><li>One Color row per IR</li><li>Periodic subtle demo noise</li><li>No A&rarr;B Lerp or WAV baking</li></ul>
