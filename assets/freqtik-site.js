...
<a class="ia-side-buy lemonsqueezy-button" href="https://freqtik.lemonsqueezy.com/checkout/buy/4b848f45-e481-4b69-9203-aaea3b9afdd4?embed=1">Buy<span class="ia-side-label">Full license &euro;49</span></a>
</nav>
...
<p class="ia-hero-fineprint">Build from two sources &middot; Draw / Path / Glue &middot; Bake reusable WAV IRs &middot; 126 included IRs &middot; Two licence seats</p>
...
<div class="ia-proof-item"><strong>Draw the route</strong><span>Author A/B movement and source-time with Draw, Path and Glue.</span></div>
...
<li>Draw, Path and Glue can control depth through the selected relationship where supported by the mode.</li>
...
<section class="ia-section ia-authoring-section" id="ia-authoring">

<div class="ia-shell">

<div class="ia-section-head"><div class="ia-copy"><span class="ia-kicker">Draw movement into the IR</span><h2>Do not automate the Morph.<br/>Author the response itself.</h2><p>The curve display is not only a visual meter. It can become the construction surface for the IR you are making.</p></div></div>

<div class="ia-shot-grid ia-shot-grid-three" aria-label="Draw Path and Glue Path examples">
<figure class="ia-feature-shot"><img src="/assets/impulse-anvil/v122/IA_03_Morph_Draw.webp" width="1128" height="697" loading="lazy" decoding="async" alt="Impulse Anvil Draw mode with an authored A to B curve"/><figcaption><strong>Draw</strong> — paint the relationship.</figcaption></figure>
<figure class="ia-feature-shot"><img src="/assets/impulse-anvil/v122/IA_04_Morph_Path.webp" width="1128" height="697" loading="lazy" decoding="async" alt="Impulse Anvil Path moving forward backward and forward through source time"/><figcaption><strong>Path</strong> — route through source-time.</figcaption></figure>
<figure class="ia-feature-shot"><img src="/assets/impulse-anvil/v122/IA_05_Morph_Glue_Path.webp" width="1128" height="697" loading="lazy" decoding="async" alt="Impulse Anvil Glue Path with separate authored source-time strokes"/><figcaption><strong>Glue Path</strong> — assemble a new timeline from pieces.</figcaption></figure>
</div>
<div class="ia-grid ia-grid-three">

<article class="ia-card"><span class="ia-tag">Draw</span><h3>Paint how A and B change</h3><p>Draw the relationship from left to right. Free endpoints let the response start or finish anywhere between A and B, and precision nodes let you clean up the useful shape.</p></article>

<article class="ia-card"><span class="ia-tag">Path</span><h3>Move through source-time</h3><p>Horizontal motion travels through the source. Move right to continue forward or left to revisit earlier material. Vertical motion controls the A/B or mode depth. A forward &rarr; backward &rarr; forward route is a real route, not a visual trick.</p></article>

<article class="ia-card"><span class="ia-tag">Glue Path</span><h3>Assemble a new timeline from pieces</h3><p>Paint separate strokes across the full prepared source timeline. Each stroke becomes the next piece of the new IR, and the distance and direction you travel determine that piece. Glue owns its duration independently of Lerp Start/Time.</p></article>

</div>

<div class="ia-portable-note"><strong>You hear the construction you are preparing to keep.</strong> Preview and Bake use the authored response path so the useful idea can become the file.</div>

<div class="ia-actions"><a class="ia-btn ia-btn-primary" href="/docs/impulse-anvil/sections/curves-path/">Learn Draw, Path &amp; Glue</a></div>
...
<div class="ia-section-head"><div class="ia-copy"><span class="ia-kicker">Pricing</span><h2>Try the core idea.<br/>Unlock the complete workstation.</h2><p>The same VST3 download opens in demo mode. A license key unlocks the complete relationship library, authored movement and WAV creation workflow.</p></div></div>
...
<ul class="ia-list"><li>Windows VST3 folder bundle</li><li>126 included IRs</li><li>Time Morph available</li><li>One Color row per IR</li><li>Periodic subtle demo noise</li><li>No A&rarr;B Lerp or WAV baking</li></ul>
...
<details><summary>What are Draw, Path and Glue Path?</summary><p>Draw paints how the selected relationship changes over the IR. Path adds source-time travel, including real backward travel through earlier material. Glue Path assembles separate painted source-time pieces into a new sequential IR and owns its duration independently of Lerp Start/Time.</p></details>
...
<details><summary>What platforms are supported?</summary><p>The main current commercial release is Windows 10/11, 64-bit VST3.</p></details>
...
<div class="ia-actions" style="justify-content:center"><a class="ia-btn ia-btn-primary ia-hero-buy" href="/downloads.html">Download free demo</a><a class="ia-btn ia-hero-buy lemonsqueezy-button" href="https://freqtik.lemonsqueezy.com/checkout/buy/4b848f45-e481-4b69-9203-aaea3b9afdd4?embed=1"><span class="ia-sale-inline"><span class="ia-old-price">€49</span><span>Buy full license · €49</span></span></a></div>
</div>
</div>
</section>
</div>
...
<section class="ia-section" id="download-install"><div class="ia-shell"><div class="ia-section-head"><div class="ia-copy"><span class="ia-kicker">Install guide</span><h2>Quick Setup — Copy/Paste</h2><p>Open both folders, then copy the full <code>Impulse Anvil.vst3</code> folder into your system VST3 folder.</p></div></div><div class="ia-install-visual"><img alt="Impulse Anvil installation guide showing the downloaded VST3 folder and the system VST3 folder side by side" loading="lazy" src="assets/impulse-anvil-install-guide.png"><p class="ia-install-note">Image guide: left = extracted download folder, right = <code>C:Program FilesCommon FilesVST3</code>.</p></div><div class="ia-grid ia-grid-three"><article class="ia-card"><div class="ia-number">1</div><h3>Extract</h3><p>Unzip <code>ImpulseAnvil_Windows_VST3.zip</code>. Keep the VST3 bundle structure intact.</p></article><article class="ia-card"><div class="ia-number">2</div><h3>Copy</h3><p>Copy the complete <code>Impulse Anvil.vst3</code> folder to <code>C:\\Program Files\\Common Files\\VST3</code>.</p></article><article class="ia-card"><div class="ia-number">3</div><h3>Rescan</h3><p>Restart or rescan your DAW. The 126 handmade IR library is bundled inside the plugin folder.</p></article></div></div></section>
